            ...
            <div className="flex h-16 items-center justify-between">
              <Link href="/">
                <h1 className="tracking-widest font-light hidden md:inline uppercase text-lg">
                  <span className="bg-gray-100 p-2 rounded-md shadow-light shadow-dark">
              ...
              <div className="flex items-center">
                <div className="ml-4 flow-root bg-white p-2 rounded-md lg:ml-8 shadow-light shadow-dark">
                  <a href="#" className="group -m-2 flex items-center p-2">
                    <UserCircleIcon
                      className="h-6 w-6 flex-shrink-0 text-gray-400 shadow-light-icon shadow-dark-icon"
                      aria-hidden="true"
                    />
