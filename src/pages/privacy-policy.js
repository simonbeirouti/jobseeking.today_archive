  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-auto my-20 space-y-4 bg-white p-10 rounded-md border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[4px_4px_0px_#000] transition-all">
        ...
        <p>
          jobseekingtoday follows a standard procedure of using log files. These
        ...
        <p>
          ...
          advertising partners of jobseekingtoday.
        </p>

        <p>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on jobseekingtoday, which are
        ...
        <p>
          Note that jobseekingtoday has no access to or control over these
        ...
        <p>
          ...
          shared and/or collect in jobseekingtoday. This policy is not
